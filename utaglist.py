...
KNOWNTAGS = {
    ...
    r"\vp", r"\vp*",
    # paragraphs/poetry
    r"\p", r"\po", r"\m", r"\pmo", r"\pm", r"\pmc", r"\pmr", r"\pi", r"\pi1",
    r"\pi2", r"\pi3", r"\mi", r"\nb", r"\cls", r"\lh", r"\lf", r"\li", r"\li1",
    r"\li2", r"\li3", r"\li4", r"\lim", r"\lim1", r"\lim2", r"\lim3", r"\lim4",
    r"\lim5", r"\pc", r"\pr", r"\ph", r"\ph1", r"\ph2", r"\ph3", r"\q", r"\q1",
    r"\q2", r"\q3", r"\q4", r"\qr", r"\qc", r"\qs", r"\qs*", r"\qa", r"\qac",
    r"\qac*", r"\qm", r"\qm1", r"\qm2", r"\qm3", r"\qd", r"\lik", r"\lik*",
    r"\litl", r"\litl*", r"\ts",
    r"\sd", r"\sd1", r"\sd2", r"\sd3", r"\sd4", r"\sd5", r"\b",
    # tables
    ...
    r"\wg", r"\wg*", r"\wh", r"\wh*", r"\wa", r"\wa*", r"\png", r"\png*",
    r"\jmp", r"\jmp*", r"\rb", r"\rb*", r"\rt", r"\rt*",
    # peripherals
    r"\periph",
    # study bible content
    r"\ef", r"\ef*", r"\ex", r"\ex*", r"\esb", r"\esbe", r"\cat", r"\cat*",
    # milestone quotations
    r"\qt-s", r"\qt1-s", r"\qt2-s", r"\qt3-s", r"\qt4-s", r"\qt5-s",
    r"\qt-e", r"\qt1-e", r"\qt2-e", r"\qt3-e", r"\qt4-e", r"\qt5-e",
    r"\*"
}
